...
<div id="page-container" >
   ...
   <div id="content-wrap" style="padding-top:150px; padding-left:20px; ">
    ...
    <h1 style="text-align: center;color:rgb(255,255,255,0.7);font-weight: normal;font-family: monospace;font-size: 35px;margin-top: 20px;margin-bottom: 0px;">OUR FACILITIES</h1>
            <hr style="width: 86%;">
