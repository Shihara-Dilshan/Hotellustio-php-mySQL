...
<div id="page-container">
    ...
    <div id="content-wrap" style="padding-top:240px; padding-left:20px; ">
        ...
        <div class="fade" id="logformbackgr3" style="background-color: rgb(0,0,0,0.7);position:fixed;z-index: 1;color:white;">
            ...
            <div name="loginForm"  method="POST">
                ...
                <!--LOGIN-FORM-CONTENT-->
     		    ...
     		    <h1 style="text-align: center;color:rgb(0,0,0,0.5);margin-top: 0;margin-bottom: 0px;"> Sorry curruntly the room you are looking for is not available</h1>
                ...
                <img src="assets/logos/window-close.png" style="margin-bottom: 20px;margin-top:-30px;"><br>
                    
     		    <a href="checkavailability.php"><button style="font-size: 13px; border-radius: 10px; background-color:rgb(255, 0, 0,0.7);font-family: monospace; font-weight: normal;width: auto;" >Check Another room type </button></a>
     	        <a href="ourrooms.php" style="font-size: 13; border-radius: 10px; background-color: #1ac6ff;font-family: monospace; font-weight: normal;width: 100px;color: white;padding: 14px 20px;margin: 8px 0;border: none;width: auto;;"> room page</a>
