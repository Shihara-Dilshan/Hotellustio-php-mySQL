        ...
        <div class="fade" id="logformbackgr3" style="background-color: rgb(0,0,0,0.7);position:fixed;z-index: 1;color:white;">
            ...
            <div name="loginForm"  >
                ...
                <!--LOGIN-FORM-CONTENT-->
     		    ...
     		    <h2 style="text-align: center;color:rgb(0,0,0,0.5);margin-top: 0;margin-bottom: 20px;"> Are you sure want to cancel reservation?</h2>
                <ul style="color:rgb(0,0,0,0.3);">
                    <h3>
                    <li>Your reservation will be delected</li>
                    <li>You can refund your money</li>
                ...
                <div class="btn-container" style="text-align: center;background-color: white;">
     		    ...
     		    <a href="deletereservation.php"><button style="font-size: 13px; border-radius: 10px; background-color:rgb(255, 0, 0,0.7);font-family: monospace; font-weight: normal;" > Yes-Delete </button></a>
     	        <a href="userprofile.php" style="font-size: 13; border-radius: 10px; background-color: #1ac6ff;font-family: monospace; font-weight: normal;width: 100px;color: white;padding: 14px 20px;margin: 8px 0;border: none;width: 25%;"> No</a>
