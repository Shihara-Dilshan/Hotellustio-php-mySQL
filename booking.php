...
<div id="page-container" >
   ...
   <div id="content-wrap" style="padding-top:150px; padding-left:20px; ">
    <div class="fade" id="logformbackgr3" style="background-color: rgb(0,0,0,0.6);position:absolute;z-index: 1;color:white;height: 920px;">
    <h1 style="text-align: center;color:rgb(255,255,255,0.7);font-weight: normal;font-family: monospace;font-size: 35px;margin-top: 20px;margin-bottom: 0px;">BOOKING</h1>
            <hr style="width: 86%;">
