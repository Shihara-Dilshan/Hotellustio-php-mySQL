...
<div id="page-container" >
   ...
   <div id="content-wrap" style="padding-top:240px; padding-left:20px; ">
        ...
        <div class="fade" id="logformbackgr" style="height: 869px; position: absolute; position:absolute;z-index: 1; ">
            <h1 id="tit" style="color: white;font-family: monospace;font-weight: 0;text-align: center;margin-top: 30px;z-index: 1;"> UPDATE ROOM </h1>
   			    <hr>
            <div style="margin-top: 50px;color: black;">
  
          <div class="login-container" style="padding-top: 0px">
            <form name="editpackage" action="update_A_room.php" method="POST" onsubmit="return basicvalidateForm2();">
                  <!--LOGING-FORM-HEADER-->
                <div class="head-container">
              
                         <h2 style="font-weight: normal;font-family: monospace; font-weight: normal;text-align: center;margin: 30px;padding-top: 20px;color: black;font-size: 25px;"> Select a room type   </h2>
                       
                </div>

                <!--LOGIN-FORM-CONTENT-->
              <div class="form-container">
             <h3 style="padding-top: 3%;color:black;font-family: monospace; font-weight: normal;">ROOM ID </h3>
            ...
            <button tyle="submit" name="submit" style="font-size: 13px; border-radius: 10px; background-color:#1ac6ff;font-family: monospace; font-weight: normal;width: 97%" > delete room </button>
