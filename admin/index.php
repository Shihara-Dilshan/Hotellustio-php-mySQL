...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css14/style.css">
...
<footer id="footer" style="position: absolute;top: 1079px;background-color: rgb(255, 255, 255,0.1);"> <?php include('includes/footer.php');?> </footer>
</div>
</body>
</html>
