<?php
  ...
  if(isset($_POST['submit']))
  {
        ...
        $sql = "DELETE FROM RoomType WHERE Rtypename='$crname'";

        if(mysqli_query($conn,$sql))
        {
            
            echo "<script>alert('Room Delected');
...
<div id="page-container" >
   ...
   <div id="content-wrap" style="padding-top:240px; padding-left:20px; ">
        ...
        <div class="fade" id="logformbackgr" style="height: 869px; position: absolute; position:absolute;z-index: 1; ">
            <h1 id="tit" style="color: white;font-family: monospace;font-weight: 0;text-align: center;margin-top: 30px;z-index: 1;"> DELETE ROOM </h1>
   			    <hr>
            <div style="margin-top: 50px;color: black;">
  
          <div class="login-container" style="padding-top: 0px">
            <form name="editpackage" action="deleteroom.php" method="POST" onsubmit="return basicvalidateForm2();">
                  <!--LOGING-FORM-HEADER-->
            ...
            <input type="text" name="crname" value="">
